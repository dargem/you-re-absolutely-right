...
The bot is hosted on oracle cloud so you can simply add the bot to your own server without needing to interact with any of this source code using this installation link.
